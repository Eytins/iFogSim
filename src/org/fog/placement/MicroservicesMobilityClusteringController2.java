 ...
 */
public class MicroservicesMobilityClusteringController2 extends MicroservicesController {
     ...
     * @param applications
     */
    public MicroservicesMobilityClusteringController2(String name, List<FogDevice> fogDevices, List<Sensor> sensors, List<Application> applications, List<Integer> clusterLevel, Double clusterLatency, int placementLogic, LocationHandler locator) {
    ...
    public MicroservicesMobilityClusteringController2(String name, List<FogDevice> fogDevices, List<Sensor> sensors, List<Application> applications, List<Integer> clusterLevel, Double clusterLatency, int placementLogic, Map<Integer, List<FogDevice>> monitored, LocationHandler locator) {
