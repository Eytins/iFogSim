 ...
 * @author Ming
 */
public class FinalACOProblemSolver<C, E extends Environment> extends AcoProblemSolver<C, E> {

    private static Logger logger = Logger.getLogger(FinalACOProblemSolver.class
            .getName());
